      ...
      <Grid container spacing={1}>
        <Grid item md={12} sm={12} xs={12}>
          <Box className="control-text" >
            ...
            <Typography variant='h5' sx={{fontWeight: '700' ,letterSpacing:'1px'}}>My name is Natpakal Chuejad<span style={{color: '#9b23ea',fontWeight: '700',letterSpacing:'1px' }}> (Frame) </span> I enjoy creating website and  learning something new </Typography>
